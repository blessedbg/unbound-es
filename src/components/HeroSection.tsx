...
const HeroSection: React.FC = () => {
  ...
  // Limpia un posible guion largo en "en tu cuerpo — y en"
  ...
  return (
    <section className="relative bg-gradient-to-br from-pink-50 via-white to-rose-50 overflow-hidden">
      {/* Elementos de fondo (idénticos al diseño actual) */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 pt-16 pb-12">
        <div className="text-center space-y-8 mb-16">
          {/* Insignia de acceso anticipado */}
          <div className="flex justify-center mb-8">
            <EarlyAccessBadge />
          </div>

          {/* Titular principal (exactamente como lo tenías) */}
          ...
          {/* Subtítulo (mismos spans y clases) */}
          <div
            className="
        ...
        {/* Sección de video (controles activados para poder activar sonido) */}
          ...
          <div className="video-container relative rounded-2xl overflow-hidden shadow-2xl bg-black">
            <div className="aspect-video">
              <iframe
                ...
                src="https://www.youtube-nocookie.com/embed/AHiT-tIk1uM?autoplay=1&mute=1&loop=1&playlist=AHiT-tIk1uM&playsinline=1&controls=1&modestbranding=1&rel=0&cc_load_policy=1&cc_lang_pref=es&hl=es&enablejsapi=1"
