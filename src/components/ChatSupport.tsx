  ...
  return (
    <div className="fixed bottom-4 left-4 z-50 w-80 bg-white rounded-2xl shadow-2xl border border-gray-200">
      <div className="flex items-center justify-between p-4 border-b border-gray-200">
        <h3 className="font-semibold text-gray-800">Chat de Soporte</h3>
        <button
          onClick={() => {
            setIsOpen(false);
            setShowForm(false);
      ...
      <div className="p-4">
        {!showForm ? (
          <div className="space-y-3">
            ...
            <button
              onClick={() => handleQuickMessage('¿Cuándo se lanza la Fase 1?')}
              className="w-full text-left p-3 bg-gray-50 hover:bg-gray-100 rounded-lg text-sm transition-colors"
            >
              ¿Cuándo se lanza la Fase 1?
            </button>
            
            <button
              onClick={() => handleQuickMessage('¿Funcionará esto para mi situación?')}
              className="w-full text-left p-3 bg-gray-50 hover:bg-gray-100 rounded-lg text-sm transition-colors"
            >
            ...
            <button
              onClick={() => handleQuickMessage('Tengo una pregunta diferente')}
              className="w-full text-left p-3 bg-gray-50 hover:bg-gray-100 rounded-lg text-sm transition-colors"
            >
